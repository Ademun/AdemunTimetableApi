...
public class ProfessorController {
  ...
  public CollectionModel<EntityModel<Professor>> all() {
    List<EntityModel<Professor>> professorModelList =
        professorService.all().stream().map(professorMapper::toModel).toList();
    return CollectionModel.of(professorModelList,
